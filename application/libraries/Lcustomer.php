...
class Lcustomer {
    ...
    public function cust_view($id)
    {
        ...
        $customer = $CI->Customers->company_info_get_data($company_invoice_data[0]['customer_id']);
   //    print_r($customer);
        $data = array(
             'c_name'  =>$customer[0]['customer_name'],
    ...
    public function credit_customer_list() {
        ...
        $data['due_info'] =$CI->Customers->customers_credit();
                ...
                $data['customers_credit'] =$CI->Customers->get_customers_credit();
   ...
   public function paid_customer_list() {
        ...
        $data['paid_customer']= $CI->Customers-> customers_paid();
                ...
                $data['customers_paid'] =$CI->Customers->get_customers_paid();
    ...
    public function customer_search_item($customer_id) {
        ...
        public function customer_ledger($customer_id, $start,$end) {
                ...
                $data = array(
                    ...
                    'invoice_data_cust'        => $ledger,
                    'ledger'        => $ledger,
                    'customer_name'  => $customer_detail,
                    'customer_address'        => $customer_detail,
                    'customer'       => $customer,
                ...
                $singlecustomerdetails = $CI->parser->parse('customer/customer_viewdetails', $data, true);
