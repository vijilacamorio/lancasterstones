     ...
     <div class="header-title">
          <div class="logo-holder logo-9">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active" style="color:orange"><?php echo ('Manage Agent') ?></li>
...
<div class="row">
    ...
    <div class="panel-body" style="padding-top: 0px;">
                  <div class="sortableTable__container">
                     ...
                     <div id="customers" style='padding: 30px;'>
                        <table class="table table-bordered" cellspacing="0" width="100%" >
                           <thead class="sortableTable">
<tr  class="sortableTable__header btnclr">
<th class="1 value"  data-col="1"  data-resizable-column-id="1"    ><?php echo display('sl') ?></th>

<th class="2 value"  data-col="2"  data-resizable-column-id="2"    >Agent Name</th>

<th class="3 value"  data-col="3"  data-resizable-column-id="3"   >Sales Commission</th>
...
<td class="2 value"  data-col="2">  <?php echo html_escape($timsht['agent_name']);?></a></td>
<td class="3 value"  data-col="3"><?php echo html_escape($timsht['agent_commission']);?></td>
