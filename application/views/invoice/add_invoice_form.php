                     ...
                     <table id="cscheTable" class="cscheTable table order-list"  style="width: 1730px;margin-left: 22px;" >
                        <thead>
                           <tr  >
                              ...
                              <th class="text-center" style="width: 300px;text-align: center;"><?php echo  ('Quantity') ?></th>
                     ...
                     <table id="service_1" class="service_1 serviceprovider table table-bordered">
                        ...
                        <tfoot>
                           <tr>
                              ...
                              <td colspan="2"><input type="text" name="overall_total" id="landing_amount" class="form-control overall_total" readonly style="float: left;"/></td>
                           </tr>
                           <tr>
                              <td colspan="4"></td>
