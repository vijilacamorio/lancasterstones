 ...
 -->
         ...
         <tr class="filters">
            <th class="search_dropdown" style="width: 22%;">
               ...
               <select id="pname-filter" class="form-control">
                  ...
                  <?php 
                     $customer_name  = array();
                     foreach ($customers_paid as $paidcustomer) {
                     $customer_name [] = $paidcustomer['customer_name'];
                     }
                     ...
                     foreach ($customers_paid as $paidcustomer) {
                     $customer_mobile[] = $paidcustomer['customer_mobile'];
                     }
                     ...
                     foreach ($customers_paid as $paidcustomer) {
                     $customer_email[] = $paidcustomer['customer_email'];
                     }
                     ...
                     $paid_amount = array();
                     foreach ($customers_paid as $paidcustomer) {
                     $paid_amount[] = $paidcustomer['paid_amount'];
                     }
                     $unique_paid_amount = array_unique($paid_amount); 
                    



                      foreach($unique_customer_name as $paidcustomer){  ?>
                  <option value="<?php echo $paidcustomer; ?>"><?php echo $paidcustomer; ?></option>
                  <?php }  ?>
               </select>
            </th>
            <th class="search_dropdown" style="width: 22%;">
               ...
               <select id="model-filter" class="form-control">
                  <option>Any</option>
                  <?php foreach($unique_customer_mobile as $paidcustomer){  ?>
                  <option value="<?php echo $paidcustomer; ?>"><?php echo $paidcustomer; ?></option>
                  <?php }  ?>
               </select>
            </th>
            <th class="search_dropdown" style="width: 22%;">
               ...
               <select id="category-filter" class="form-control">
                  <option>Any</option>
                  <?php foreach($unique_customer_email as $paidcustomer){  ?>
                  <option value="<?php echo $paidcustomer; ?>"><?php echo $paidcustomer; ?></option>
                  <?php }  ?>
               </select>
            </th>
            <th class="search_dropdown" style="width: 200px;">
               ...
               <select id="unit-filter" class="form-control">
                  <option>Any</option>
                  <?php foreach($unique_phone as $paidcustomer){  ?>
                  <option value="<?php echo $paidcustomer; ?>"><?php echo $paidcustomer; ?></option>
                  <?php }  ?>
               </select>
            </th>
            <th class="search_dropdown" style="width: 22%;">
               ...
               <select id="supplier-filter" class="form-control">
                  <option>Any</option>
                  <?php foreach($unique_paid_amount as $paidcustomer){  ?>
                  <option value="<?php echo $paidcustomer; ?>"><?php echo $paidcustomer; ?></option>
                  <?php }  ?>
               </select>
            </th>
   ...
   <table>
      <tr>
                     ...
                     <td style="width:22%;">   <input type="text" class="form-control" id="myInput1" onkeyup="search()" placeholder="Search for Customer Name.."></td>
                     <td style="width:10px;"></td>
                     ...
                     <td style="width:10px;"></td>
                     <td style="width: 213px;"> <input type="text" class="form-control" id="myInput5" onkeyup="search()" placeholder="Search for Paid Amount.."></td>
                  </tr>
   </table>
   <br/>
   <div class="col-sm-12">
   <input id="search" type="text" class="form-control"  placeholder="Search for Paid Customer">
 </div>
</div>
</div>
...
?>
 ...
 <tr style="text-align:center" class="task-list-row" data-task-id="<?php echo $count; ?>" data-pname="<?php echo $arr['customer_name']; ?>" data-model="<?php echo $arr['customer_mobile']; ?>" data-category="<?php echo $arr['customer_email']; ?>" data-unit="<?php echo $arr['phone']; ?>" data-supplier="<?php echo $arr['paid_amount'];  ?>">
