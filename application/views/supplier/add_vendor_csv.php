...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <div class="header-title">
            <h1><?php echo  ('Import Supplier Csv') ?></h1>
            <small><?php //echo display('import_product_csv') ?></small>
            <ol class="breadcrumb">
                <li><a href="<?php echo base_url('')?>"><i class="pe-7s-home"></i> <?php echo display('home') ?></a></li>
                <li><a href="<?php echo base_url('Supplier')?>">
                 <li class="active" style="color:orange"><?php echo  ('Import Supplier Csv') ?></li>
            </ol>
        </div>
    </section>
...
<a style="background-color:#38469f;color:white;" href="<?php echo base_url('Csupplier/manage_supplier') ?>" class="btn  m-b-5 m-r-2"><i class="ti-align-justify"> </i> <?php echo ('Manage Supplier') ?> </a>
 </div>   
            ...
            <div class="col-sm-12">
                <div class="panel panel-bd">
                    <div class="panel-heading">
                        <div class="panel-title">
                            <h4><?php echo display('add_vendor_csv') ?></h4>
                        </div>
                    </div>
