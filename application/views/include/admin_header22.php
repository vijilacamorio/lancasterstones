            ...
            <ul class="nav navbar-nav">
                 ...
                 <li class="dropdown notifications-menu">
                    <a href="<?php echo base_url('Cservice/help_desk_show') ?>" >
                        ...
                        <span class="label label-danger">Help</span>
                    </a>
                </li>
    ...
    <div class="row">
                  ...
                  <div class="menuCol col-xl-3 col-lg-3 col-md-12">
                    <ul class="dropdown-submenu">
                        ...
                        <li class="menu-title">Manage Settings<a href="#"></a></li>
                         <li><a href="https://interactivewebtech.net/erpwork/Admin_dashboard/edit_profile"><i class="pe-7s-users"></i>myManage Company</a></li>
                        <li><a href="https://interactivewebtech.net/erpwork/Admin_dashboard/dashboardsetting"><i class="ti-dashboard"></i>Add Companys</a></li>
                  ...
                  <div class="menuCol col-xl-3 col-lg-3 col-md-12">
                    <ul class="dropdown-submenu">
                         ...
                         <li class="menu-title">Role Permission<a href="#"></a></li>
                        <li><a href="https://interactivewebtech.net/erpwork/Permission/add_role">Add Role<i class="pe-7s-users"></i></a></li>
                        <li><a href="https://interactivewebtech.net/erpwork/Permission/role_list">Role List<i class="ti-dashboard"></i></a></li>
                        <li><a href="https://interactivewebtech.net/erpwork/Permission/user_assign">User Assign Role<i class="pe-7s-settings"></i></a></li>
                   ...
                   <div class="menuCol col-xl-3 col-lg-3 col-md-12">
                    <ul class="dropdown-submenu">
                         ...
                         <li class="menu-title">SMS<a href="#"></a></li>
                        <li><a href="https://interactivewebtech.net/erpwork/Csms/configure">SMS Configure<i class="pe-7s-users"></i></a></li>
                    </ul>
                  </div>
                  ...
                  <div class="menuCol col-xl-3 col-lg-3 col-md-12">
                    <ul class="dropdown-submenu">
                         ...
                         <li class="menu-title">Admin Details<a href="#"></a></li>
           ...
           <li class="treeview <?php
            ...
            ?>">
             ...
             <a href="<?php echo base_url('Csupplier/manage_supplier') ?>">
                    <i class="ti-user"></i><span>Add Vendor</span>
...
<!-- New Account End -->
        ...
        <?php } ?>
            ...
            ?>">
             ...
             <a href="<?php echo base_url('Caccounts/invoice_wise_tax_report') ?>">
                    <i class="ti-user"></i><span>Tax Reports</span>
            ...
            ?>">
                ...
                <ul class="treeview-menu">
                    ...
                    <li class="treeview <?php if ($this->uri->segment('2') == ("manage_company")){
                        ...
                        echo " ";
                    }?>"><a href="<?php echo base_url('Company_setup/manage_company') ?>"><?php echo 'my'.display('manage_company') ?></a></li>
                <?php }?>
                <?php if($this->permission1->method('add_user','create')->access()){?>
                    <li class="treeview <?php if ($this->uri->segment('1') == ("User") && $this->uri->segment('2') == ("")){
                        ...
                        echo " ";
                    }?>"><a href="<?php echo base_url('User') ?>"><?php echo 'Add Company';//display('add_user') ?></a></li>
                <?php }?>
                  <?php if($this->permission1->method('manage_user','read')->access()){?>
                    <li class="treeview <?php if ($this->uri->segment('2') == ("manage_user")){
                        ...
                        echo " ";
                    }?>"><a href="<?php echo base_url('User/manage_user') ?>"><?php echo 'Manage Company'; //display('manage_users') ?> </a></li>
                <?php }?>
