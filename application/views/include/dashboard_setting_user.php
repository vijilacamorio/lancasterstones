            ...
            <div class="panel panel-bd">
               <div class="panel-heading">
                ...
                <div class="panel-body">
                  <?php echo form_open_multipart('Admin_dashboard/dashboardsettingUser',array('class' => 'form-vertical', 'id' => 'update_userpage','name' => 'update_userpage'))?>
                      ...
                      <table class="table table-bordered table-striped table-hover">
                        ...
                        <tbody>
                           ...
                           <tr>
                              ...
                              <td class="text-right">
                                 ...
                                 <input class="form-control" type="checkbox" <?php if($single['status']=='enable'){ echo 'checked'; } ?> name="userpage_status[<?php echo $single['slug']; ?>]" >
                              </td>
                           </tr>
                           <?php
                              }
                        ...
                        <tfoot>
                           <tr>
                              ...
                              <td><center><input type="submit" class="btnclr btn m-b-5 m-r-2" name="save" value="Save Action"></center></td>
                           </tr>
                        </tfoot>
                     </table>
                  </div>
