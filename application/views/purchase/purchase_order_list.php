                  ...
                  <div class="row"   style="height:0px;">
                     ...
                     <div id="for_filter_by" class="for_filter_by" style="display: inline;padding-top: -1px;    margin-right: 13px;">
                        ...
                        <select id="filterby" style="border-radius:5px;height:25px;">
                              ...
                              <option value="4"><?php echo display('Phone')?></option>
                              <option value="5"><?php echo display('Payment Terms')?></option>
                              <option value="6"><?php echo display('Vendor Address')?></option>
                              ...
                              <option value="16"><?php echo ('Grand Total');?></option>
                     ...
                     <div id="customers">
                        <table class="table table-bordered" cellspacing="0" width="100%" id="ProfarmaInvList">
                           ...
                           <tr   class="sortableTable__header btnclr">
                                 ...
                                 <th data-col="4" class="4 value" name="Shipto" data-control-column="4" style="height: 39.0114px; width: 150.011px;text-align:center;color: white;" ><?php echo  ('Phone')?></th>
                                 ...
                                 <th data-col="6" class="6 value" name="ShipmentTerms" data-control-column="6" style="height: 39.0114px; width: 150.011px;text-align:center;color: white;" ><?php echo  ('Vendor Address')?></th>
                                 ...
                                 <th data-col="16" name="GrandTotal(Preferred Currency)" class="16 value" data-control-column="16" style="height: 39.0114px; width: 150.011px;text-align:center;color: white;" ><?php echo ('Grand Total')?></th>
                            ...
                            <tbody class="sortableTable__body" id="tab">
                              ...
                              <tr style="text-align:center" class="task-list-row" data-task-id="<?php echo $count; ?>" data-pname="<?php echo $arr['chalan_no']; ?>" data-model="<?php echo $arr['payment_terms']; ?>" data-category="<?php echo $arr['shipment_terms']; ?>" data-unit="<?php echo $arr['supplier_id'] ?>" data-supplier="<?php echo $arr['ship_to'];  ?>">
                                                ...
                                                class="task-list-row"
                                                  ...
                                                  data-unit="<?php echo $arr['supplier_id']; ?>"
                                 ...
                                 <td data-col="2" class="2" style="text-align:center;white-space: nowrap;"><?php   echo $arr['chalan_no'];  ?></td>
                                                                  ...
                                                                  <td data-col="11" class="11" style="text-align:center;white-space: nowrap;"><?php   echo $arr['supplier_id'];  ?></td>
                                 ...
                                 <!-- <td data-col="7" class="7" style="text-align:center;"><?php   echo $arr['est_ship_date'];  ?></td> -->
                                                                  ...
                                                                  <td data-col="10" class="10" style="text-align:center;"><?php    echo $currency." ".$arr['total'];  ?></td>
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/jspdf-autotable/3.0.0-alpha.1/jspdf.plugin.autotable.js"></script>
  ...
  <div id="myModal_colSwitch"   name="myPurchaseorderName"      class="modal_colSwitch" >
                    <div class="modal-content_colSwitch" style="width:40%;height:30%;">
                          ...
                          <input type="checkbox"    data-control-column="1" style="margin-top: -1px;"    class=" 1" value="1"/>&nbsp; <?php echo display('ID')?><br><br>
                          <input type="checkbox"  checked="checked"  data-control-column="2" style="margin-top: -1px;"   class=" 2" value="2"/>&nbsp;<?php echo display('Invoice No')?><br><br>
                          <input type="checkbox"  checked="checked"  data-control-column="3" style="margin-top: -1px;"    class=" 3" value="3"/>&nbsp;<?php echo display('purchase_date')?><br><br>
                          <input type="checkbox"     data-control-column="4"    class=" 4" style="margin-top: -1px;" value="4"/>&nbsp;<?php echo ('Phone No')?><br><br>
                         </div>
                         </div>
                          <div class="col-sm-3"><br><br>
                          <div class="form-group row">
                          <input type="checkbox"     data-control-column="5" style="margin-top: -1px;"  class=" 5" value="5"/>&nbsp;<?php echo display('Payment Terms')?><br><br>
                          <input type="checkbox"  data-control-column="6" style="margin-top: -1px;"  class=" 6" value="6"/>&nbsp;<?php echo  ('Vendor Address')?><br><br>
                           <input type="checkbox"  data-control-column="16"  style="margin-top: -1px;"   class="16" value="16"/>&nbsp;<?php echo  ('Grand Total')?><br><br>
                           <input type="checkbox"  data-control-column="14" style="margin-top: -1px;"    class=" 14" value="14"/>&nbsp;<?php echo display('P.O Number')?><br>   <br>
                          </div>
                          </div>
                            <div class="col-sm-3"><br><br>
                            <div class="form-group row">
                          <input type="checkbox"  data-control-column="15" style="margin-top: -1px;" class=" 15" value="15"/>&nbsp;<?php echo display('Tax Details')?><br><br>
                          <input type="checkbox"  data-control-column="17" style="margin-top: -1px;"  class="17" value="17"/>&nbsp;<?php echo display('Remarks / Details')?><br><br>
                         <!-- <input type="checkbox"  data-control-column="18" style="margin-top: -1px;" checked = "checked" class=" 18" value="18"/>&nbsp;<?php echo display('action')?><br><br> -->
                            </div>
                             </div>
                </div>
                </div>
