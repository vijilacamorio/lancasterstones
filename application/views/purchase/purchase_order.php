...
<div class="content-wrapper">
   ...
   <section class="content">
                  ...
                  <div class="row">
                        <div class="col-sm-6">
                           <div class="form-group row">
                              ...
                              <input type="text"   name="supplier_id" class="form-control"   style="width: 98%;border: 2px solid #d7d4d6;"  />
                           ...
                           <label for="date" class="col-sm-4 col-form-label"><?php echo ('Date');?>
                              ...
                              <div class="col-sm-8">
                                 ...
                                 <input type="date"  tabindex="2" class="form-control datepicker"  style="width: 98%;border: 2px solid #d7d4d6;"  name="purchase_date" value="<?php echo $date5; ?>" id="date5"   />
                              </div>
                           </div>
                        </div>
                     </div>
                     ...
                     <div class="row">
                      ...
                      <div class="col-sm-6">
                        ...
                        <!--      </label>-->
                        <!--      <div class="col-sm-8">-->
                        <!--         <textarea class="form-control" tabindex="4" id="shipment_terms" name="shipment_terms"  rows="3" cols="70" style="width: 99%;border: 2px solid #d7d4d6;"   rows="2"  ></textarea>-->
                        <!--      </div>-->
                        <!--   </div>-->
                            ...
                            <div class="form-group row">
                              ...
                              <div class="col-sm-8">
                                 <textarea class="form-control" tabindex="4" id="shipment_terms" name="shipment_terms"  rows="3" cols="70" style="width: 98%;border: 2px solid #D7D4D6;"   rows="2"  ></textarea>
                              </div>
                           </div>
                              ...
                              <div class="col-sm-8">
                                 <input type="number"   name="ship_to" class="form-control"   style="width: 98%;border: 2px solid #d7d4d6;"    />
                              </div>
                           </div>
                        </div>
				       ...
				       <div class="col-sm-6">
                           ...
                           <label for="adress" class="col-sm-4 col-form-label"><?php  echo display('payment_type'); ?>
                              ...
                              <input type="text"    name="paytype_drop" class="form-control"  id="paytype_drop"    style="width: 98%;border: 2px solid #d7d4d6;"     />
     ...
     <div class="form-group row">
                              ...
                              <input type="text"    name="payment_terms" class="form-control"   style="width: 98%;border: 2px solid #d7d4d6;"     />
                                 </div>
                              </div>
                     ...
                     <div class="table-responsive">
                        <div id="content">
                           <table class="cscheTable table table-bordered normalinvoice table-hover" id="normalinvoice_1" style="width: -webkit-fill-available;border: 2px solid #d7d4d6;">
                              <thead>
                                 <tr>
...
<th     class="text-center"   ><?php echo ('Rate') ?></th>
                              ...
                              <tbody id="addPurchaseItem_1">
                                 <tr>
                                    ...
                                    <td >
                                       <span class="input-symbol-euro"><input  type="text" class="total_price form-control"   readonly placeholder="0.00"  id="total_amt_1"     name="total_amt[]"/></span>
                                    </td>
                              ...
                              <tfoot>
                                 <tr>
                                    ...
                                    <td style="text-align:right;    height: 50px;" colspan="5"><b><?php  echo display('total'); ?>:</b></td>
                                    <td >
                                       <span class="input-symbol-euro">    <input type="text" id="Over_all_Total" name="Over_all_Total"   class="b_total form-control"    value="0.00"  readonly="readonly"  /> </span>
                                    </td>
                                 </tr>
                              </tfoot>
                           </table>
                        ...
                        <table class="taxtab table table-bordered table-hover"  style="border: 2px solid #d7d4d6;"  >
                           <tr>
                           <td colspan="3" style="text-align:right;width: 72%;font-weight:bold;">Tax : </td>
                              <td style='width:0px;'>
                                 <input list="magic_purchaseorder" name="tx" style="width: 200px;"   id="product_tax" class="form-control"   onchange="this.blur();" />
                                 <datalist id="magic_purchaseorder">
                                    ...
                                    <?php } ?>
                                       ...
                                       <td>
                            <a href="#" class="btnclr client-add-btn btn " aria-hidden="true" style="color:white;"  data-toggle="modal" data-target="#purchasetax_info" ><i class="fa fa-plus"></i></a></td>
                           </tr>
                        </table>
                        ...
                        <table border="0"  class="overall table table-bordered table-hover"  style="border: 2px solid #d7d4d6;table-layout: auto;"  >
                           ...
                           <tr style="height:50px;">
                              ...
                              <td colspan="5" style="width: 130px;text-align:right;border:none;"><b><?php  echo display('TAX DETAILS');?> :</b></td>
                              <td colspan="1" style="border:none;width:140px">  <span class="input-symbol-euro">     <input type="text" class="form-control" style="width:200px;"  id="tax_details" value="0.00" name="tax_details"  readonly="readonly" /></span></td>
                           </tr>
                           ...
                           <tr>
                              ...
                              <td colspan="1" style="border:none;">  <span class="input-symbol-euro">       <input type="text" id="gtotal"   class="vendor_gtotal form-control" style="width:200px;" name="vendor_gtotal" value="0.00"  readonly="readonly" /></td>
                           </tr>
             ...
             <tr>
                              ...
                              <td colspan="5"  class="amt" style="text-align:right;border:none;"><b><?php  echo display('Amount Paid');?> :</b></td>
                               ...
                               <td colspan="1"  style="border:none;">
                                       <table border="0">
                                          <tr class="amt">                                         
                                              <td> <span class="input-symbol-euro">  <input  type="text" class="form-control"  readonly id="amount_paid" style="width:200px"  name="amount_paid"  required   /> </span></td>
                                          </tr>
                                       </table>
                                    </td>
                           ...
                           <tr class="amt"    style="height: 50px;"  >
                              <td colspan="2"  style="vertical-align:top;text-align:right;border:none;"></td>
                              <td colspan="1" style="border:none;"></td>
                              <td class="amt" colspan="5"  style="text-align:right;border:none;"><b><?php echo display('balance_ammount');  ?> :</b></td>
                              <td class="amt" style="border:none;" colspan="1">
                                 <table border="0">
                                    <tr class="amt">
                                       <td>
                                       <span class="input-symbol-euro">   <input  type="text"  class="form-control" readonly id="balance"  style="width:200px" name="balance"  required   />   </span>                  
                                       </td>
                                    </tr>
...
<div class="modal fade" id="myModal1" role="dialog" >
               ...
               <div class="row">
                  ...
                  <div class="form-group row">
                     <label for="bank"         style="text-align: start;width: 30%;margin-left: 85px;"               class="col-sm-3 col-form-label"><?php echo  display('Select Bank');?><i class="text-danger">*</i></label>
                                        ...
                                        <a data-toggle="modal" href="#add_bank_info"   class="btn btnclr" style="margin-right:35px;"><i class="fa fa-university"></i></a>
  ...
  class="col-sm-3 col-form-label"><?php  echo  display('Amount to be paid');?> </label>
                     <div class="col-sm-5">
                        <table border="0">
                           <tr>
                               <td><input  type="text"  readonly name="amount_to_pay" id="amount_to_pay"   style="width:230%;" class="form-control" required   /></td>
                           </tr>
                        </table>
                     </div>
                  </div>
 ...
 class="col-sm-3 col-form-label"><?php  echo  display('Amount Received');?> </label>
                     <div class="col-sm-5">
                        <table border="0">
                           <tr>
                               <td><input  type="text"  readonly name="amount_received" value="0.00"  style="width:230%;" id="amount_received" class="form-control"required   /></td>
                           </tr>
                        </table>
                     </div>
                  </div>
 ...
 class="col-sm-3 col-form-label"><?php  echo display('balance_ammount'); ?></label>
                     <div class="col-sm-5">
                        <table border="0">
                           <tr>
                               <td><input  type="text"   readonly name="balance_modal"    style="width:230%;" id="balance_modal" class="form-control" required  /></td>
                           </tr>
                        </table>
                     </div>
                  </div>
 ...
 class="col-sm-3 col-form-label"><?php  echo  display('payment_amount');?> <i class="text-danger">*</i></label>
                     <div class="col-sm-5">
                        <table border="0">
                           <tr>
                               <td><input  type="text"   name="payment" id="payment_from_modal"     style="width:230%;" class="form-control"required   /></td>
                           </tr>
                        </table>
                     </div>
                  </div>
...
<script>
   ...
   $('#insert_purchase').submit(function(e) {
            ...
            form_data.append('<?php echo $this->security->get_csrf_token_name(); ?>', '<?php echo $this->security->get_csrf_hash(); ?>');
              ...
              $.ajax({
                  url: '<?php echo base_url(); ?>Cpurchase/purchase_file_upload', 
                  dataType: 'text', 
                  cache: false,
                  contentType: false,
                  processData: false,
...
$(".ui-sortable").hover(function () {
 ...
 $(".addrow").on("click", function () {
    ...
    '</td>';
     ...
     cols += '<td class="col-sm-5"><div class="input-group"><input type="text" name="thickness[]"  readonly  class="thickness form-control"/><button class="btn-cSche"><i class="fa fa-link" aria-hidden="true"></i></button></span></div></td>';
     ...
     cols += '<td class="col-sm-1"><button class="delete" id="deleterow"><i class="fa fa-trash-o" aria-hidden="true"></i></button></td>';
     cols += "</tr>";
...
// });
   ...
   $('#Over_all_Total').val(costpersqft).trigger('change');
   calculate();
