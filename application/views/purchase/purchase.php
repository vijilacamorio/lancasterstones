...
<div class="content-wrapper">
   ...
   <section class="content">
            ...
            <div id="search_area" style="border:4px solid #004d99;border-radius:7px;">
                        ...
                        <th class="search_dropdown" style="width: 22%;">
                           ...
                           <select id="pname-filter" class="form-control">
                              ...
                              <?php 
                                 ...
                                 $payment_terms[] = $expense['chalan_no'];
                             
                                                            //   $payment_terms += array($expense['chalan_no'], $servpro['bill_number']);
                                 ...
                                 $supplier_name = array();
                                 foreach ($expenses as $expense) {
                                 // $supplier_name[] = $expense['supplier_id'];                            
                                  $supplier_name[] = $expense['supplier_id'] ; 
                                  }
               ...
               <!--<table>-->
                  ...
                  <!--<tr>-->
                     ...
                     <!--<td style="width:25%;">   <input type="text" class="form-control" id="myInput1" onkeyup="search()" placeholder="Search for purchase Id.."></td>-->
                     <!--<td style="width:10px;"></td>-->
                     <!--<td style="width:22%;"> <input type="text" class="form-control" id="myInput2" onkeyup="search()" placeholder="Search for Phone No.."></td>-->
                     <!--<td style="width:10px;"></td>-->
                     <!--<td style="width:16%;">  <input type="text" class="form-control" id="myInput3" onkeyup="search()" placeholder="Search for Invoice No.."></td>-->
                     <!--<td style="width:10px;"></td>-->
                     <!--<td style="width:18%;"> <input type="text" class="form-control" id="myInput4" onkeyup="search()" placeholder="Search for purchase Date.."></td>-->
                     <!--<td style="width:10px;"></td>-->
                     <!--<td style="width:18%;"> <input type="text" class="form-control" id="myInput5" onkeyup="search()" placeholder="Search for Grand Total.."></td>-->
                  <!--</tr>-->
                  ...
                  <div class="row"   style="height:0px;">
                     ...
                     <div id="for_filter_by" class="for_filter_by" style="display: inline;padding-top: -1px;    margin-right: 13px;">
                        ...
                        <select id="filterby" style="border-radius:5px;height:25px;">
                           ...
                           <option value="2"><?php echo  ('Invoice No')?></option>
                        ...
                        <table class="table table-bordered" cellspacing="0" width="100%" id="ProfarmaInvList">
                           <thead class="sortableTable">
                              ...
                              <tr   class="sortableTable__header btnclr">
                                 ...
                                 <th data-col="2" class="2 value" name="InvoiceNo " data-control-column="2"  style="height: 39.0114px; width: 150.011px;text-align:center;color: white;" ><?php echo  ('Invoice No')?></th>

                                 <th data-col="1" class="1 value" name="Name" data-control-column="1"  style="height: 39.0114px; width: 150.011px;text-align:center;color: white;"><?php echo  ('Name')?></th>
    ...
    <?php
    $count = 1;
    if (!empty($allinfo) && count($allinfo[0]) > 0) {
        foreach ($allinfo[0] as $arr) {
            ?>
            <tr style="text-align:center" class="task-list-row" data-task-id="<?php echo $count; ?>" data-pname="<?php echo $arr['chalan_no']; ?>" data-model="<?php echo $arr['vtype']; ?>" data-category="<?php echo $arr['chalan_no']; ?>" data-unit="<?php echo $arr['supplier_id'] ?>" data-supplier="<?php echo $arr['payment_due_date']; ?>">
                ...
                <td data-col="0" class="0"><?php  echo $count;  ?></td>
                                 ...
                                 <td data-col="1" class="1" style="text-align:center;white-space:nowrap;" ><?php  if(!empty($arr['service_provider_name']  && $arr['service_provider_name'] !== 'N/A' )) { echo $arr['service_provider_name'];}    else if(!empty($arr['supplier_id'] && $arr['supplier_id'] !== 'N/A' )){echo $arr['supplier_id'];}     else if($arr['service_provider_name'] == 'N/A' || $arr['supplier_name'] == 'N/A'){echo 'N/A';}  ?></td>
                                                                 ...
                                                                 <td data-col="18" class="18" style="text-align:center;"><?php  if(!empty($arr['vtype'] )) { echo $arr['vtype'];}else{echo "N/A";}  ?></td>
